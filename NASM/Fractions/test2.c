 ...
 * this file extensively tests the del_frac and new_frac functions to handle
 * complex situations
 */
...
int main() {
   ...
   printf("\nAdd one variable and print! Three should be left. \n");
   ...
   printf("\nAdd two more variables! There should be two spots left. \n");
   ...
   printf("\nNow remove the second item! It should be returned to the top of the list. \n");
   del_frac(fp2);
   dump_heap();

   printf("\nNow add three more items. There should be no spaces left.\n");
   ...
   printf("\nNow delete with an empty free list!\n");
